...
def test_gpu_model_validation():
    ...
    gpu_ok, msg = checker._check_gpu(
        requirements_datacenter['hardware']['gpu'],
        cluster_with_a100
    )
    ...
    gpu_ok, msg = checker._check_gpu(
        requirements_a100['hardware']['gpu'],
        cluster_with_a100
    )
    print(f"  Result: {'✅ PASS' if gpu_ok else '❌ FAIL'}")
    print(f"  Message: {msg}")
    ...
    gpu_ok, msg = checker._check_gpu(
        requirements_a100_or_newer['hardware']['gpu'],
        cluster_with_h100
    )
    print(f"  Result: {'✅ PASS' if gpu_ok else '❌ FAIL'}")
    print(f"  Message: {msg}")
    ...
    gpu_ok, msg = checker._check_gpu(
        requirements_a100_or_l4['hardware']['gpu'],
        cluster_with_l4
    )
    print(f"  Result: {'✅ PASS' if gpu_ok else '❌ FAIL'}")
    print(f"  Message: {msg}")
    ...
    gpu_ok, msg = checker._check_gpu(
        requirements_high_end['hardware']['gpu'],
        cluster_with_rtx4090
    )
    print(f"  Result: {'✅ PASS' if gpu_ok else '❌ FAIL'}")
    print(f"  Message: {msg}")
    ...
    gpu_ok, msg = checker._check_gpu(
        requirements_mi250['hardware']['gpu'],
        cluster_with_mi250
    )
    print(f"  Result: {'✅ PASS' if gpu_ok else '❌ FAIL'}")
    print(f"  Message: {msg}")
    ...
    gpu_ok, msg = checker._check_gpu(
        requirements_quantity_only['hardware']['gpu'],
        cluster_with_t4
    )
    print(f"  Result: {'✅ PASS' if gpu_ok else '❌ FAIL'}")
    print(f"  Message: {msg}")
